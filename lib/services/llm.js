...
export function listModels() {
  return [
    ...
    { id: 'qwen/qwen3.6-plus:free', name: 'Qwen3: Qwen3.6 Plus', type: 'chat', enabled: true, maxTokens: 2048 },
    { id: 'nvidia/nemotron-3-super-120b-a12b:free', name: 'NVIDIA: Nemotron 3 Super', type: 'chat', enabled: true, maxTokens: 4096 },
    { id: 'arcee-ai/trinity-large-preview:free', name: 'Arcee AI: Trinity', type: 'chat', enabled: true, maxTokens: 2048 }
  ]
}
