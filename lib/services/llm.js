...
export function listModels() {
  return [
    ...
    { id: 'qwen/qwen3.6-plus:free', name: '标准1', type: 'chat', enabled: true, maxTokens: 2048 },
    { id: 'nvidia/nemotron-3-super-120b-a12b:free', name: '标准2', type: 'chat', enabled: true, maxTokens: 4096 },
    { id: 'arcee-ai/trinity-large-preview:free', name: '专业', type: 'chat', enabled: true, maxTokens: 2048 }
  ]
}
